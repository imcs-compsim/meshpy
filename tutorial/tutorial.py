...
from meshpy import (mpy, Mesh, MaterialReissner, Beam3rHerm2Line3,
    BoundaryCondition, Rotation, Function, GeometrySet, InputFile)
...
def tutorial(base_dir, preview=False):
    ...
    print('Point couplings before "couple_nodes": {}'.format(
    ...
    mesh.add(BoundaryCondition(geometry_set_all_lines,
