...
class TestFullBaci(unittest.TestCase):
    ...
    def test_honeycomb_variants(self):
        ...
        input_file.add(InputSection(
            'RESULT DESCRIPTION',
            '''
            STRUCTURE DIS structure NODE 206 QUANTITY dispx VALUE 0.253781056143393358 TOLERANCE 1e-10
            STRUCTURE DIS structure NODE 206 QUANTITY dispy VALUE 0.783709185261938779 TOLERANCE 1e-10
            STRUCTURE DIS structure NODE 206 QUANTITY dispz VALUE 0.292961504428914332 TOLERANCE 1e-10
            STRUCTURE DIS structure NODE 531 QUANTITY dispx VALUE 0.270635999935110616 TOLERANCE 1e-10
            STRUCTURE DIS structure NODE 531 QUANTITY dispy VALUE 0.811942419568978835 TOLERANCE 1e-10
            STRUCTURE DIS structure NODE 531 QUANTITY dispz VALUE 0.296708585882769105 TOLERANCE 1e-10
